              ...
              <Card shadow>
                ...
                <Form style="padding: 16px;">
                  ...
                  <FormItem label="站内资讯" :label-width="90">
                    <Input   type="textarea" v-model="config.explain" :rows="4" maxlength="1000"  placeholder="请输入站内资讯/公告文本(留空则不显示,支持html标签)" />
                  </FormItem>
                  <FormItem label="关于弹窗" :label-width="90">
                    <Input   type="textarea" v-model="config.aboutinfo" :rows="4" maxlength="1000"  placeholder="请输入站内关于菜单的内容,支持html标签" />
                  </FormItem>
              ...
              <Card shadow>
                ...
                <Form style="padding: 16px;">
                  ...
                  <FormItem label="程序版本" :label-width="110">
                    <Input clearable v-model="appclient.appupdate" maxlength="50"  placeholder="按照格式严谨填写：如1.0.1" style="max-width: 600px;" />
                  </FormItem>
