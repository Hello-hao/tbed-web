          ...
          <Content>
            <Form ref="formInline" :model="formInline" :rules="ruleInline" inline @submit.native.prevent>
              ...
              <FormItem prop="email" style="display: inline-block;width: 80%;">
                <Input prefix="md-mail" size="large" v-model="formInline.email" :maxlength="200" placeholder="邮箱"
                       autocomplete="new-password" style="width: 100%;height: 40px;"/>
              </FormItem>
              <FormItem prop="password" style="display: inline-block;width: 80%;">
                <Input prefix="md-lock" type="password" size="large" :maxlength="200" v-model="formInline.password"
                       autocomplete="new-password" placeholder="用户密码" style="width: 100%;height: 40px;"/>
              </FormItem>
              <FormItem prop="password" style="display: inline-block;width: 80%;">
                <Input prefix="md-lock" type="password" size="large" :maxlength="200" v-model="formInline.passwordtow"
                       autocomplete="new-password" placeholder="确认用户密码" style="width: 100%;height: 40px;"/>
              </FormItem>
              <FormItem style="display: inline-block;width: 80%;">
                <Row>
                  <Col span="16">
                    <Input prefix="md-barcode" placeholder="验证码" :maxlength="10" :rules="ruleInline"
                           autocomplete="new-password" v-model="formInline.verifyCode" size="large"
                           style="width: 100%;height: 40px;"/>
                  </Col>
                  <Col span="4" offset="1">
